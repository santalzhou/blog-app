...
import { Wrapper, Header, Footer, ConfirmB, BackB, HInupt } from './style'
...
class Write extends Component {
  ...
  render() {
    return (
      <Wrapper>
        <Header>添加文章
          <HInupt placeholder='输入文章标题' onChange={this.changeTitle}></HInupt>
        </Header>
        <div ref={this.editorElemMenu}
        ...
        <Footer>
          <ConfirmB onClick={this.submitArti}>发布</ConfirmB>
          <BackB>返回</BackB>
        </Footer>
      </Wrapper>
    )
  ...
  submitArti() {
    if (!this.state.editorContent) return;
